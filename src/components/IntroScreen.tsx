...
export const IntroScreen = ({ onStart, onAuth }: IntroScreenProps) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[hsl(var(--background-gradient-start))] via-[hsl(var(--background-gradient-mid))] to-[hsl(var(--background-gradient-end))]">
      {/* Desktop Header */}
      <div className="hidden md:flex sticky top-0 z-50 bg-gradient-to-b from-[hsl(var(--background-gradient-start))] via-[hsl(var(--background-gradient-mid))] to-[hsl(var(--background-gradient-end))] backdrop-blur-sm px-6 py-3 justify-between items-center">
      ...
      {/* Mobile Header */}
      <div className="md:hidden bg-gradient-to-b from-[hsl(var(--background-gradient-start))] via-[hsl(var(--background-gradient-mid))] to-[hsl(var(--background-gradient-end))] px-4 py-4">

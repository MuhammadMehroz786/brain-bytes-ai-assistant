...
export const IntroScreen = ({
  ...
  return <div className="min-h-screen bg-[#f4faff]">
      ...
      <div className="hidden lg:flex sticky top-0 z-50 bg-[#f4faff] px-6 py-3 justify-between items-center">
        ...
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <div className="relative">
            ...
            <div className="absolute -bottom-4 -left-12 w-16 h-10 bg-gradient-to-br from-cyan-300/30 via-sky-300/30 to-blue-300/30 rounded-full blur-lg opacity-50 z-0" style={{
      ...
      <div className="hidden lg:block relative overflow-hidden">
        ...
        <div className="absolute bottom-20 right-12 w-[400px] h-[250px] bg-gradient-to-br from-cyan-300/20 via-sky-300/20 to-blue-400/20 rounded-full blur-3xl animate-bounce opacity-50" style={{
        animationDuration: '8s'
      }}></div>
        
        {/* Additional accent blobs */}
        <div className="absolute top-1/3 right-1/4 w-32 h-20 bg-gradient-to-br from-lavender-300/30 via-purple-300/30 to-indigo-300/30 rounded-full blur-xl opacity-40" style={{
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className="grid lg:grid-cols-2 gap-16 items-center min-h-[70vh]">
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                <Button onClick={handlePaymentClick} size="lg" className="bg-gradient-to-r from-primary to-accent hover:from-primary/90 hover:to-accent/90 text-white font-semibold text-lg px-8 py-6 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-base h-auto">

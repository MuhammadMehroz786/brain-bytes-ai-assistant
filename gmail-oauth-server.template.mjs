...
app.listen(port, 'localhost', () => {
  console.log(`🚀 Gmail OAuth server running at http://localhost:${port}`);
  console.log('🔗 OAuth callback URL: http://localhost:8082/callback');
  console.log('📧 Ready to handle Gmail OAuth requests!');
});
